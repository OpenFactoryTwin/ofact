...
def create_state_model(state_model_file_name, order_amount):
    ...
    order_date_list = [
        datetime(2025, 11, 5, 12, 0, 0),
        datetime(2025, 11, 5, 12, 0, 0),
        datetime(2025, 11, 5, 12, 0, 0),
        datetime(2025, 11, 5, 12, 0, 0),
        datetime(2025, 11, 5, 12, 0, 0),
        datetime(2025, 11, 5, 12, 0, 0),
        datetime(2025, 11, 5, 13, 0, 0),
        datetime(2025, 11, 5, 13, 0, 0),
        datetime(2025, 11, 5, 13, 0, 0),
        datetime(2025, 11, 5, 13, 0, 0),
        datetime(2025, 11, 5, 13, 0, 0),
...
if __name__ == "__main__":
    # --- load defaults + YAML ---
    defaults = {
        "start_time_simulation": datetime(2025, 11, 6, 7),
